...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3"><label>Заголовок (английский)</label><input type="text" name="title_en" class="form-control"></div>
            ...
            <div class="mb-3"><label>Содержание (английский)</label><textarea name="content_en" class="form-control tinymce" rows="10"></textarea></div>
